...
static CsrUint32 write_tag(void *buf, const CsrUint32 offset,
                           const CsrInt8 *tag_str);
static CsrUint32 write_chunk(void *buf, const CsrUint32 offset,
                             const CsrInt8 *tag_str, const CsrUint32 payload_len);
...
static CsrUint32
xbv2uint(CsrUint8 *ptr, CsrInt32 len)
{
    CsrUint32 u = 0;
    CsrInt16 i;
...
static CsrInt32
read_bytes(card_t *card, ct_t *ct, void *buf, CsrUint32 len)
{
    /* read the tag value */
...
static CsrInt32
read_uint(card_t *card, ct_t *ct, CsrUint32 *u, CsrUint32 len)
{
    CsrUint8 buf[4];
...
static CsrUint32
write_uint16(void *buf, const CsrUint32 offset, const CsrUint16 val)
{    
...
static CsrUint32
write_uint32(void *buf, const CsrUint32 offset, const CsrUint32 val)
{
...
static CsrUint32
write_bytes(void *buf, const CsrUint32 offset, const CsrUint8 *data, const CsrUint32 len)
{
    CsrUint32 i;
    CsrUint8 *dst = (CsrUint8 *)buf + offset;
...
static CsrUint32
write_tag(void *buf, const CsrUint32 offset, const CsrInt8 *tag_str)
{
    CsrUint8 *dst = (CsrUint8 *)buf + offset;
...
static CsrUint32
write_chunk(void *buf, const CsrUint32 offset, const CsrInt8 *tag_str, const CsrUint32 payload_len)
{
    CsrUint32 written = 0;
...
static CsrUint16
calc_checksum(void *buf, const CsrUint32 offset, const CsrUint32 bytes_len)
{
    CsrUint32 i;
...
static CsrUint32
calc_patch_size(const xbv1_t *fwinfo)
{
    CsrInt16 i;
    CsrUint32 size = 0;
...
static CsrUint32
write_xbv_header(void *buf, const CsrUint32 offset, const CsrUint32 file_payload_length)
{
    CsrUint32 written = 0;
     ...
     */
    written += write_chunk(buf, offset + written, (CsrInt8 *)"XBV1", file_payload_length + 6);
    
    written += write_chunk(buf, offset + written, (CsrInt8 *)"VERF", 2);
...
static CsrUint32
write_ptch_header(void *buf, const CsrUint32 offset, const CsrUint32 fw_id)
{
    CsrUint32 written = 0;

    /* LIST is written with a zero length, to be updated later */
    written += write_chunk(buf, offset + written, (CsrInt8 *)"LIST", 0);  
    written += write_tag(buf, offset + written, (CsrInt8 *)"PTCH");        /* List type */
    
    written += write_chunk(buf, offset + written, (CsrInt8 *)"FWID", 4);   
...
static CsrUint32
write_patchcmd(void *buf, const CsrUint32 offset, const CsrUint32 dst_genaddr, const CsrUint16 len)
{
    CsrUint32 written = 0;
...
static CsrUint32
write_fwdl_to_ptdl(void *buf, const CsrUint32 offset, fwreadfn_t readfn,
                   ...
                   const CsrUint32 fw_id, void *fw_buf)
{
    ...
    while (left) {
        ...
        written += write_chunk(buf, offset + written, (CsrInt8 *)"PTDL", sec_len);
...
static CsrUint32
write_reset_ptdl(void *buf, const CsrUint32 offset, const xbv1_t *fwinfo, CsrUint32 fw_id)
{
    CsrUint32 written = 0;
    CsrUint16 csum;
    CsrUint32 csum_start_offs;    /* first offset to include in checksum */    
                   ...
                   const void *fw_buf, const xbv1_t *fwinfo, CsrUint32 *size)
{
    ...
    unifi_trace(card->ospriv, UDBG1, "XBV:PTCH size %d, fw_id %d\n",
                patch_offs, fw_id);
    if (size) {
        *size = patch_offs; 
    }
