...
*
*  PURPOSE:  chiphelper functions.
*
*  $Id: //depot/dot11/v7.0p/apps/util/chiputil/chiphelper.c#1 $
*
***********************************************************************/
...
/* One of the Generic Windows on UF602x and later. */
...
/* The three windows on UF602x and later. */
...
{
    { FALSE, 0x00ff, 0x0022, 0x07 },        /* UF602x */
    "UF602x",
    "UniFi-4",
