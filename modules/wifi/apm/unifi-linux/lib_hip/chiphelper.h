...
/**********************************************************************
   ...
   PURPOSE:  
    ...
    all sorts of information about different CSR chips.  It doesn't
    contain any code that "does" anything, it just returns numbers,
    strings and bools that tell you things.  It is meant to be used 
    ...
    At the moment no information about the windows is assumed.

   $Id: //depot/dot11/v7.0p/apps/util/chiputil/chiphelper.h#1 $
...
#define CHIP_HELPER_LIST(m)                                             \
    ...
    CHIP_HELPER_DEF1(m, (CsrUint16, WINDOW_ADDRESS, enum chip_helper_window_index)) \
    CHIP_HELPER_DEF1(m, (CsrUint16, WINDOW_SIZE, enum chip_helper_window_index)) \
    CHIP_HELPER_DEF1(m, (CsrUint16, MapAddress_SPI2HOST, CsrUint16))          \
    CHIP_HELPER_DEF1(m, (CsrUint16, MapAddress_HOST2SPI, CsrUint16))          \
...
/*  SDIO_HOST_INT
    ...
    protocol specification.  Thier names should probably be changed
