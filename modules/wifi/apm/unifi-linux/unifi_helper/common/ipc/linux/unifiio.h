...
#ifdef CSR_ONLY_NOTES
#define IWPRIV_INFO_MAX_STRING 160
#define SIOCIWGINFOPRIV SIOCIWFIRSTPRIV + 9
#endif
 ...
 *         In:uint (f/w buffer length)   if Cmd==UNIFI_PUTEST_DL_FW_BUFF
 ...
 *         In:f/w buffer                 if Cmd==UNIFI_PUTEST_DL_FW_BUFF
 */
...
typedef enum unifiio_coredump_space {
    UNIFIIO_COREDUMP_MAC_REG=0,
    UNIFIIO_COREDUMP_PHY_REG=1,
    UNIFIIO_COREDUMP_SH_DMEM=2,
    UNIFIIO_COREDUMP_MAC_DMEM=3,
    UNIFIIO_COREDUMP_PHY_DMEM=4,
    UNIFIIO_COREDUMP_TRIGGER_MAGIC = 0xFEEDFACE
