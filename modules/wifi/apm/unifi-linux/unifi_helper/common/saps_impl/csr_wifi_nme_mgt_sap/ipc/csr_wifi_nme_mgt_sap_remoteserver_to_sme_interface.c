...
static void event_to_unifi_nme_mgt_association_complete_ind(FsmContext* context, CsrUint8* inputbuffer, CsrUint16 length)
{
    CsrUint8* buffer = &inputbuffer[6];
    UnifiNmeMgtAssociationCompleteInd_Evt evt;
    ...
    unifi_nme_mgt_association_complete_ind(context, evt.appHandlesCount, evt.appHandles, evt.status, &evt.connectionInfo, evt.deauthReason);
...
static void event_to_unifi_nme_mgt_association_start_ind(FsmContext* context, CsrUint8* inputbuffer, CsrUint16 length)
{
    CsrUint8* buffer = &inputbuffer[6];
    UnifiNmeMgtAssociationStartInd_Evt evt;
    ...
    unifi_nme_mgt_association_start_ind(context, evt.appHandlesCount, evt.appHandles, &evt.address, &evt.ssid);

    CsrPfree(evt.appHandles);
}

static void event_to_unifi_nme_mgt_blacklist_cfm(FsmContext* context, CsrUint8* inputbuffer, CsrUint16 length)
{
    CsrUint8* buffer = &inputbuffer[6];
    UnifiNmeMgtBlacklistCfm_Evt evt;
    ...
    unifi_nme_mgt_blacklist_cfm(context, evt.appHandle, evt.status, evt.action, evt.getAddressCount, evt.getAddresses);

    CsrPfree(evt.getAddresses);
}

static void event_to_unifi_nme_mgt_connect_cfm(FsmContext* context, CsrUint8* inputbuffer, CsrUint16 length)
{
    CsrUint8* buffer = &inputbuffer[6];
    UnifiNmeMgtConnectCfm_Evt evt;

    evt.appHandle = (void*) event_unpack_CsrUint32(&buffer);
    evt.status = (unifi_Status) event_unpack_CsrUint8(&buffer);

    unifi_nme_mgt_connect_cfm(context, evt.appHandle, evt.status);

}

static void event_to_unifi_nme_mgt_connection_quality_ind(FsmContext* context, CsrUint8* inputbuffer, CsrUint16 length)
{
    CsrUint8* buffer = &inputbuffer[6];
    UnifiNmeMgtConnectionQualityInd_Evt evt;
    ...
    unifi_nme_mgt_connection_quality_ind(context, evt.appHandlesCount, evt.appHandles, &evt.linkQuality);

    CsrPfree(evt.appHandles);
}

static void event_to_unifi_nme_mgt_disconnect_cfm(FsmContext* context, CsrUint8* inputbuffer, CsrUint16 length)
{
    CsrUint8* buffer = &inputbuffer[6];
    UnifiNmeMgtDisconnectCfm_Evt evt;

    evt.appHandle = (void*) event_unpack_CsrUint32(&buffer);
    evt.status = (unifi_Status) event_unpack_CsrUint8(&buffer);

    unifi_nme_mgt_disconnect_cfm(context, evt.appHandle, evt.status);

}

static void event_to_unifi_nme_mgt_event_mask_set_cfm(FsmContext* context, CsrUint8* inputbuffer, CsrUint16 length)
{
    CsrUint8* buffer = &inputbuffer[6];
    UnifiNmeMgtEventMaskSetCfm_Evt evt;

    evt.appHandle = (void*) event_unpack_CsrUint32(&buffer);
    evt.status = (unifi_Status) event_unpack_CsrUint8(&buffer);

    unifi_nme_mgt_event_mask_set_cfm(context, evt.appHandle, evt.status);

}

static void event_to_unifi_nme_mgt_get_value_cfm(FsmContext* context, CsrUint8* inputbuffer, CsrUint16 length)
{
    CsrUint8* buffer = &inputbuffer[6];
    UnifiNmeMgtGetValueCfm_Evt evt;
    ...
    unifi_nme_mgt_get_value_cfm(context, evt.appHandle, evt.status, &evt.appValue);
...
static void event_to_unifi_nme_mgt_ibss_station_ind(FsmContext* context, CsrUint8* inputbuffer, CsrUint16 length)
{
    CsrUint8* buffer = &inputbuffer[6];
    UnifiNmeMgtIbssStationInd_Evt evt;
    ...
    unifi_nme_mgt_ibss_station_ind(context, evt.appHandlesCount, evt.appHandles, &evt.address, evt.isconnected);

    CsrPfree(evt.appHandles);
}

static void event_to_unifi_nme_mgt_key_cfm(FsmContext* context, CsrUint8* inputbuffer, CsrUint16 length)
{
    CsrUint8* buffer = &inputbuffer[6];
    UnifiNmeMgtKeyCfm_Evt evt;

    evt.appHandle = (void*) event_unpack_CsrUint32(&buffer);
    evt.status = (unifi_Status) event_unpack_CsrUint8(&buffer);
    evt.action = (unifi_ListAction) event_unpack_CsrUint8(&buffer);

    unifi_nme_mgt_key_cfm(context, evt.appHandle, evt.status, evt.action);

}

static void event_to_unifi_nme_mgt_media_status_ind(FsmContext* context, CsrUint8* inputbuffer, CsrUint16 length)
{
    CsrUint8* buffer = &inputbuffer[6];
    UnifiNmeMgtMediaStatusInd_Evt evt;
    ...
    unifi_nme_mgt_media_status_ind(context, evt.appHandlesCount, evt.appHandles, evt.mediaStatus, &evt.connectionInfo, evt.disassocReason, evt.deauthReason);
...
static void event_to_unifi_nme_mgt_mib_get_cfm(FsmContext* context, CsrUint8* inputbuffer, CsrUint16 length)
{
    CsrUint8* buffer = &inputbuffer[6];
    UnifiNmeMgtMibGetCfm_Evt evt;
    ...
    unifi_nme_mgt_mib_get_cfm(context, evt.appHandle, evt.status, evt.mibAttributeLength, evt.mibAttribute);

    CsrPfree(evt.mibAttribute);
}

static void event_to_unifi_nme_mgt_mib_get_next_cfm(FsmContext* context, CsrUint8* inputbuffer, CsrUint16 length)
{
    CsrUint8* buffer = &inputbuffer[6];
    UnifiNmeMgtMibGetNextCfm_Evt evt;
    ...
    unifi_nme_mgt_mib_get_next_cfm(context, evt.appHandle, evt.status, evt.mibAttributeLength, evt.mibAttribute);

    CsrPfree(evt.mibAttribute);
}

static void event_to_unifi_nme_mgt_mib_set_cfm(FsmContext* context, CsrUint8* inputbuffer, CsrUint16 length)
{
    CsrUint8* buffer = &inputbuffer[6];
    UnifiNmeMgtMibSetCfm_Evt evt;

    evt.appHandle = (void*) event_unpack_CsrUint32(&buffer);
    evt.status = (unifi_Status) event_unpack_CsrUint8(&buffer);

    unifi_nme_mgt_mib_set_cfm(context, evt.appHandle, evt.status);

}

static void event_to_unifi_nme_mgt_mic_failure_ind(FsmContext* context, CsrUint8* inputbuffer, CsrUint16 length)
{
    CsrUint8* buffer = &inputbuffer[6];
    UnifiNmeMgtMicFailureInd_Evt evt;
    ...
    unifi_nme_mgt_mic_failure_ind(context, evt.appHandlesCount, evt.appHandles, evt.secondFailure, evt.count, &evt.address, evt.keyType, evt.keyId, evt.tsc);

    CsrPfree(evt.appHandles);
}

static void event_to_unifi_nme_mgt_multicast_address_cfm(FsmContext* context, CsrUint8* inputbuffer, CsrUint16 length)
{
    CsrUint8* buffer = &inputbuffer[6];
    UnifiNmeMgtMulticastAddressCfm_Evt evt;
    ...
    unifi_nme_mgt_multicast_address_cfm(context, evt.appHandle, evt.status, evt.action, evt.getAddressesCount, evt.getAddresses);

    CsrPfree(evt.getAddresses);
}

static void event_to_unifi_nme_mgt_packet_filter_set_cfm(FsmContext* context, CsrUint8* inputbuffer, CsrUint16 length)
{
    CsrUint8* buffer = &inputbuffer[6];
    UnifiNmeMgtPacketFilterSetCfm_Evt evt;

    evt.appHandle = (void*) event_unpack_CsrUint32(&buffer);
    evt.status = (unifi_Status) event_unpack_CsrUint8(&buffer);

    unifi_nme_mgt_packet_filter_set_cfm(context, evt.appHandle, evt.status);

}

static void event_to_unifi_nme_mgt_pmkid_cfm(FsmContext* context, CsrUint8* inputbuffer, CsrUint16 length)
{
    CsrUint8* buffer = &inputbuffer[6];
    UnifiNmeMgtPmkidCfm_Evt evt;
    ...
    unifi_nme_mgt_pmkid_cfm(context, evt.appHandle, evt.status, evt.action, evt.getPmkidsCount, evt.getPmkids);

    CsrPfree(evt.getPmkids);
}

static void event_to_unifi_nme_mgt_pmkid_candidate_list_ind(FsmContext* context, CsrUint8* inputbuffer, CsrUint16 length)
{
    CsrUint8* buffer = &inputbuffer[6];
    UnifiNmeMgtPmkidCandidateListInd_Evt evt;
    ...
    unifi_nme_mgt_pmkid_candidate_list_ind(context, evt.appHandlesCount, evt.appHandles, evt.pmkidCandidatesCount, evt.pmkidCandidates);

    CsrPfree(evt.appHandles);
    CsrPfree(evt.pmkidCandidates);
}

static void event_to_unifi_nme_mgt_restricted_access_disable_cfm(FsmContext* context, CsrUint8* inputbuffer, CsrUint16 length)
{
    CsrUint8* buffer = &inputbuffer[6];
    UnifiNmeMgtRestrictedAccessDisableCfm_Evt evt;

    evt.appHandle = (void*) event_unpack_CsrUint32(&buffer);
    evt.status = (unifi_Status) event_unpack_CsrUint8(&buffer);

    unifi_nme_mgt_restricted_access_disable_cfm(context, evt.appHandle, evt.status);

}

static void event_to_unifi_nme_mgt_restricted_access_enable_cfm(FsmContext* context, CsrUint8* inputbuffer, CsrUint16 length)
{
    CsrUint8* buffer = &inputbuffer[6];
    UnifiNmeMgtRestrictedAccessEnableCfm_Evt evt;

    evt.appHandle = (void*) event_unpack_CsrUint32(&buffer);
    evt.status = (unifi_Status) event_unpack_CsrUint8(&buffer);

    unifi_nme_mgt_restricted_access_enable_cfm(context, evt.appHandle, evt.status);

}

static void event_to_unifi_nme_mgt_roam_complete_ind(FsmContext* context, CsrUint8* inputbuffer, CsrUint16 length)
{
    CsrUint8* buffer = &inputbuffer[6];
    UnifiNmeMgtRoamCompleteInd_Evt evt;
    ...
    unifi_nme_mgt_roam_complete_ind(context, evt.appHandlesCount, evt.appHandles, evt.status);

    CsrPfree(evt.appHandles);
}

static void event_to_unifi_nme_mgt_roam_start_ind(FsmContext* context, CsrUint8* inputbuffer, CsrUint16 length)
{
    CsrUint8* buffer = &inputbuffer[6];
    UnifiNmeMgtRoamStartInd_Evt evt;
    ...
    unifi_nme_mgt_roam_start_ind(context, evt.appHandlesCount, evt.appHandles, evt.roamReason, evt.reason80211);

    CsrPfree(evt.appHandles);
}

static void event_to_unifi_nme_mgt_scan_full_cfm(FsmContext* context, CsrUint8* inputbuffer, CsrUint16 length)
{
    CsrUint8* buffer = &inputbuffer[6];
    UnifiNmeMgtScanFullCfm_Evt evt;

    evt.appHandle = (void*) event_unpack_CsrUint32(&buffer);
    evt.status = (unifi_Status) event_unpack_CsrUint8(&buffer);

    unifi_nme_mgt_scan_full_cfm(context, evt.appHandle, evt.status);

}

static void event_to_unifi_nme_mgt_scan_result_ind(FsmContext* context, CsrUint8* inputbuffer, CsrUint16 length)
{
    CsrUint8* buffer = &inputbuffer[6];
    UnifiNmeMgtScanResultInd_Evt evt;
    ...
    unifi_nme_mgt_scan_result_ind(context, evt.appHandlesCount, evt.appHandles, &evt.result);

    CsrPfree(evt.appHandles);
    CsrPfree(evt.result.informationElements);
}

static void event_to_unifi_nme_mgt_scan_results_flush_cfm(FsmContext* context, CsrUint8* inputbuffer, CsrUint16 length)
{
    CsrUint8* buffer = &inputbuffer[6];
    UnifiNmeMgtScanResultsFlushCfm_Evt evt;

    evt.appHandle = (void*) event_unpack_CsrUint32(&buffer);
    evt.status = (unifi_Status) event_unpack_CsrUint8(&buffer);

    unifi_nme_mgt_scan_results_flush_cfm(context, evt.appHandle, evt.status);

}

static void event_to_unifi_nme_mgt_scan_results_get_cfm(FsmContext* context, CsrUint8* inputbuffer, CsrUint16 length)
{
    CsrUint8* buffer = &inputbuffer[6];
    UnifiNmeMgtScanResultsGetCfm_Evt evt;
    ...
    unifi_nme_mgt_scan_results_get_cfm(context, evt.appHandle, evt.status, evt.scanResultsCount, evt.scanResults);
...
static void event_to_unifi_nme_mgt_set_value_cfm(FsmContext* context, CsrUint8* inputbuffer, CsrUint16 length)
{
    CsrUint8* buffer = &inputbuffer[6];
    UnifiNmeMgtSetValueCfm_Evt evt;

    evt.appHandle = (void*) event_unpack_CsrUint32(&buffer);
    evt.status = (unifi_Status) event_unpack_CsrUint8(&buffer);
    evt.appValueId = (unifi_AppValueId) event_unpack_CsrUint8(&buffer);

    unifi_nme_mgt_set_value_cfm(context, evt.appHandle, evt.status, evt.appValueId);

}

static void event_to_unifi_nme_mgt_tspec_ind(FsmContext* context, CsrUint8* inputbuffer, CsrUint16 length)
{
    CsrUint8* buffer = &inputbuffer[6];
    UnifiNmeMgtTspecInd_Evt evt;
    ...
    unifi_nme_mgt_tspec_ind(context, evt.appHandlesCount, evt.appHandles, evt.transactionId, evt.tspecResultCode, evt.tspecLength, evt.tspec);

    CsrPfree(evt.appHandles);
    CsrPfree(evt.tspec);
}

static void event_to_unifi_nme_mgt_tspec_cfm(FsmContext* context, CsrUint8* inputbuffer, CsrUint16 length)
{
    CsrUint8* buffer = &inputbuffer[6];
    UnifiNmeMgtTspecCfm_Evt evt;
    ...
    unifi_nme_mgt_tspec_cfm(context, evt.appHandle, evt.status, evt.transactionId, evt.tspecResultCode, evt.tspecLength, evt.tspec);

    CsrPfree(evt.tspec);
}

static void event_to_unifi_nme_mgt_wifi_flightmode_cfm(FsmContext* context, CsrUint8* inputbuffer, CsrUint16 length)
{
    CsrUint8* buffer = &inputbuffer[6];
    UnifiNmeMgtWifiFlightmodeCfm_Evt evt;

    evt.appHandle = (void*) event_unpack_CsrUint32(&buffer);
    evt.status = (unifi_Status) event_unpack_CsrUint8(&buffer);

    unifi_nme_mgt_wifi_flightmode_cfm(context, evt.appHandle, evt.status);

}

static void event_to_unifi_nme_mgt_wifi_off_ind(FsmContext* context, CsrUint8* inputbuffer, CsrUint16 length)
{
    CsrUint8* buffer = &inputbuffer[6];
    UnifiNmeMgtWifiOffInd_Evt evt;
    ...
    unifi_nme_mgt_wifi_off_ind(context, evt.appHandlesCount, evt.appHandles, evt.controlIndication);

    CsrPfree(evt.appHandles);
}

static void event_to_unifi_nme_mgt_wifi_off_cfm(FsmContext* context, CsrUint8* inputbuffer, CsrUint16 length)
{
    CsrUint8* buffer = &inputbuffer[6];
    UnifiNmeMgtWifiOffCfm_Evt evt;

    evt.appHandle = (void*) event_unpack_CsrUint32(&buffer);
    evt.status = (unifi_Status) event_unpack_CsrUint8(&buffer);

    unifi_nme_mgt_wifi_off_cfm(context, evt.appHandle, evt.status);

}

static void event_to_unifi_nme_mgt_wifi_on_cfm(FsmContext* context, CsrUint8* inputbuffer, CsrUint16 length)
{
    CsrUint8* buffer = &inputbuffer[6];
    UnifiNmeMgtWifiOnCfm_Evt evt;

    evt.appHandle = (void*) event_unpack_CsrUint32(&buffer);
    evt.status = (unifi_Status) event_unpack_CsrUint8(&buffer);

    unifi_nme_mgt_wifi_on_cfm(context, evt.appHandle, evt.status);
...
static const event_to_fn fnlookup1[56] = {
        NULL,
        event_to_unifi_nme_mgt_wifi_on_cfm,
        NULL,
        event_to_unifi_nme_mgt_wifi_off_cfm,
        event_to_unifi_nme_mgt_wifi_off_ind,
        NULL,
        event_to_unifi_nme_mgt_wifi_flightmode_cfm,
        NULL,
        event_to_unifi_nme_mgt_set_value_cfm,
        NULL,
        event_to_unifi_nme_mgt_get_value_cfm,
        NULL,
        event_to_unifi_nme_mgt_mib_set_cfm,
        NULL,
        event_to_unifi_nme_mgt_mib_get_cfm,
        NULL,
        event_to_unifi_nme_mgt_mib_get_next_cfm,
        NULL,
        event_to_unifi_nme_mgt_scan_full_cfm,
        NULL,
        event_to_unifi_nme_mgt_scan_results_get_cfm,
        event_to_unifi_nme_mgt_scan_result_ind,
        NULL,
        event_to_unifi_nme_mgt_connect_cfm,
        event_to_unifi_nme_mgt_media_status_ind,
        event_to_unifi_nme_mgt_connection_quality_ind,
        NULL,
        event_to_unifi_nme_mgt_disconnect_cfm,
        NULL,
        event_to_unifi_nme_mgt_multicast_address_cfm,
        event_to_unifi_nme_mgt_mic_failure_ind,
        event_to_unifi_nme_mgt_pmkid_candidate_list_ind,
        NULL,
        event_to_unifi_nme_mgt_pmkid_cfm,
        NULL,
        event_to_unifi_nme_mgt_key_cfm,
        NULL,
        event_to_unifi_nme_mgt_packet_filter_set_cfm,
        NULL,
        event_to_unifi_nme_mgt_tspec_cfm,
        event_to_unifi_nme_mgt_tspec_ind,
        NULL,
        event_to_unifi_nme_mgt_scan_results_flush_cfm,
        NULL,
        event_to_unifi_nme_mgt_blacklist_cfm,
        event_to_unifi_nme_mgt_roam_start_ind,
        event_to_unifi_nme_mgt_roam_complete_ind,
        event_to_unifi_nme_mgt_association_start_ind,
        event_to_unifi_nme_mgt_association_complete_ind,
        event_to_unifi_nme_mgt_ibss_station_ind,
        NULL,
        event_to_unifi_nme_mgt_event_mask_set_cfm,
        NULL,
        event_to_unifi_nme_mgt_restricted_access_enable_cfm,
        NULL,
        event_to_unifi_nme_mgt_restricted_access_disable_cfm,

};


CsrBool remote_csr_wifi_nme_mgt_signal_receive(FsmContext* context, CsrUint8* buffer, CsrUint16 size)
{
