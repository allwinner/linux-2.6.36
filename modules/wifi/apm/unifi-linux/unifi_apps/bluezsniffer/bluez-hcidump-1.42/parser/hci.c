...
#ifdef IPC_IP
    switch (evt->link_type) {
    case 0x00:
        sniff_sco_connect_complete(evt);
        break;
    case 0x01:
        sniff_acl_connect_complete(evt);
        break;
    case 0x02:
        printf("%s connect complete (sniff_sco_sync_connect_complete should have been called)\n", linktype2str(evt->link_type));
        break;
    default:
        printf("Error: %s\n", linktype2str(evt->link_type));
        break;
...
#ifdef IPC_IP
	sniff_sco_sync_connect_complete(evt);
#endif
}
