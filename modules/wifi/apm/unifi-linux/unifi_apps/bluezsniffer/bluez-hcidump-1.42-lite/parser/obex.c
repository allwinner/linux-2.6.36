...
/*TODO: add obex signalling
 *
 * should we work off commands or responses?  we have our option here...
 *
 * NOTE: i have worked off the connect and disconnect for now as the data
 * originally appeared to come before the indications.  i now think this is
 * a parsing problem with hcidump.  it may be that the first data commands
 * include the get/put but the spec is not very clear, at least to me.
 *
 * as luck would have it, i am surrounded by bt experts here and should be
 * able to ask one tomorrow.
 *
 ...
 */
 			...
 			case 0x00:	/* Connect */
 				printf(">>OBEX_CONNECT:\n");
#ifdef IPC_IP
                sniff_obex_start(frm->handle);
#endif
 				break;
			case 0x01:	/* Disconnect */
				printf(">>OBEX_DISCONNECT:\n");
#ifdef IPC_IP
				sniff_obex_stop(frm->handle);
#endif
				break;
			case 0x02:	/* Put */
				printf(">>OBEX_PUT:\n");
