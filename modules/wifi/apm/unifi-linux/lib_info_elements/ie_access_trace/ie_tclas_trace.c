...
CsrUint8* ie_trace_tclas(CsrUint8 traceLevel, CsrUint8 *pBuf)
{
    CsrUint32 value;
    ...
    ie_CsrUint8(pBuf, value);         CsrLog(traceLevel, (CsrString*)"", (CsrString*)"userPriority:              0x%.2x", value );
    pBuf = ie_trace_frame_classifier(traceLevel, pBuf);
