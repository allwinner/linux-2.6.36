 ...
 *
 *----------------------------------------------------------------------------*/
extern void CsrBgintSet(CsrBgint irq);
 ...
 *----------------------------------------------------------------------------*/
#ifdef STRING_LOG__
extern CsrMsgId CsrPutMessageStringLog(CsrQid q,
                         CsrUint16 mi,
                         void *mv,
                         CsrUint32 line,
                         CsrString *file);
#define CsrPutMessage(q, mi, mv) CsrPutMessageStringLog((q), (mi), (mv), __LINE__, (CsrString *) __FILE__)
#else
extern CsrMsgId CsrPutMessage(CsrQid q,
                         CsrUint16 mi,
                         void *mv);
#endif
...
extern void CsrBroadcastMessageStringLog(CsrUint16 mi,
                              ...
                              CsrUint32 line,
                              CsrString *file);
#define CsrBroadcastMessage(mi, fn, ptr) CsrBroadcastMessageStringLog((mi), (fn), (ptr), __LINE__, (CsrString *) __FILE__)
#else
extern void CsrBroadcastMessage(CsrUint16 mi,
                              void *(*msg_build_func)(void*),
                              void *msg_build_ptr);
#endif
...
extern CsrTid CsrTimedEventInStringLog(CSR_TIME delay,
                          ...
                          CsrUint32 line,
                          CsrString *file);
#define CsrTimedEventIn(d, fn, fni, fnv) CsrTimedEventInStringLog((d), (fn), (fni), (fnv), __LINE__, (CsrString *) __FILE__)
#else
 ...
 *----------------------------------------------------------------------------*/
#ifdef STRING_LOG__
extern CsrBool CsrCancelTimedEventStringLog(CsrTid eventid,
                                 CsrUint16 *pmi,
                                 void **pmv,
                                 CsrUint32 line,
                                 CsrString *file);
#define CsrCancelTimedEvent(e, pmi, pmv) CsrCancelTimedEventStringLog((e), (pmi), (pmv), __LINE__, (CsrString *) __FILE__)
#else
...
/* Register a task */
void CsrSchedRegisterTask(CsrQid *queue,
                         schedEntryFunction_t init,
                         schedEntryFunction_t deinit,
                         schedEntryFunction_t handler,
                         const CsrString *name,
                         CsrUint16 task_id,
                         const CsrString *task_id_ver,
                         void *data,
                         CsrUint16 id);
