 ...
 */
char firmware_path[MOD_PARAM_PATHLEN] = "/drv/fw_bcm4329.bin";
char nvram_path[MOD_PARAM_PATHLEN] = "/drv/nvram.txt";
...
#if LINUX_VERSION_CODE >= KERNEL_VERSION(2, 6, 35)  //add by barbara 2011.4.27
	struct netdev_hw_addr *ha;						//add by barbara 2011.4.27
#else												//add by barbara 2011.4.27
	struct dev_mc_list *mclist;
#endif												//add by barbara 2011.4.27
	uint32 allmulti, cnt;
...
#if LINUX_VERSION_CODE >= KERNEL_VERSION(2, 6, 35)	//add by barbara 2011.4.27
	cnt = netdev_mc_count(dev);						//add by barbara 2011.4.27
#else												//add by barbara 2011.4.27
	mclist = dev->mc_list;
	cnt = dev->mc_count;
#endif												//add by barbara 2011.4.27
...
#if LINUX_VERSION_CODE >= KERNEL_VERSION(2, 6, 35)	//add by barbara 2011.4.27
	netdev_for_each_mc_addr(ha, dev) {				//add by barbara 2011.4.27
		if (!cnt)									//add by barbara 2011.4.27
			break;									//add by barbara 2011.4.27
		memcpy(bufp, ha->addr, ETHER_ADDR_LEN);		//add by barbara 2011.4.27
		bufp += ETHER_ADDR_LEN;						//add by barbara 2011.4.27
		cnt--;										//add by barbara 2011.4.27
	}												//add by barbara 2011.4.27
#else												//add by barbara 2011.4.27
