...
#define MMC_SDHC1_VIRT_ADDR IO_ADDRESS(MMC_SDHC1_BASE_ADDR)

#define imx31_sdhc_readl(x)	ioread32((MMC_SDHC1_VIRT_ADDR)+(x))
#define imx31_sdhc_readw(x)	ioread16((MMC_SDHC1_VIRT_ADDR)+(x))
#define imx31_sdhc_readb(x)	ioread8((MMC_SDHC1_VIRT_ADDR)+(x))

#define imx31_sdhc_writel(v,x)	iowrite32((v),(MMC_SDHC1_VIRT_ADDR)+(x))
#define imx31_sdhc_writew(v,x)	iowrite16((v),(MMC_SDHC1_VIRT_ADDR)+(x))
#define imx31_sdhc_writeb(v,x)	iowrite8((v),(MMC_SDHC1_VIRT_ADDR)+(x))
/*!
