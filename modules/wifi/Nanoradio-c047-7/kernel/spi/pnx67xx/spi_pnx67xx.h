...
//#define DMA_LEN_THRESHOLD       16
#define DMA_LEN_THRESHOLD      1
...
extern u16 spi_read_frame(struct pnx67xx_spi *spi);
extern void spi_write_stat(struct pnx67xx_spi *spi, u16 value);
extern u16 spi_read_data(struct pnx67xx_spi *spi);
extern void spi_read_buf(struct pnx67xx_spi *spi, u16* buf, int len );
extern void spi_write_buf(struct pnx67xx_spi *spi, u16* buf, int len );
...
extern int spi_read_timer_stat(struct pnx67xx_spi *spi);
...
extern void pnx67xx_do_hw_transfer( struct pnx67xx_spi *pnx_spi, 
				u16* tx_buf, u16* rx_buf, u32 len );
