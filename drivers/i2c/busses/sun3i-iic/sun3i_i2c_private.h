...
*********************************************************************************************************
*/
#ifndef _SUN3I_I2C_PRIVATE_H_
#define _SUN3I_I2C_PRIVATE_H_



#define TWI_MODULE_NUM    (3)

/* TWI Register physical base address */
#define TWI0_BASE_ADDR  (0x01C24000)
#define TWI1_BASE_ADDR  (0x01C24400)
#define TWI2_BASE_ADDR  (0x01C26C00)
...
/* internel use only function */
extern void aw_twi_get_byte(void *base_addr, unsigned char  *buffer);
extern void aw_twi_get_last_byte(void *base_addr, unsigned char  *buffer);
extern void aw_twi_put_byte(void *base_addr, const unsigned char  *buffer);
extern void aw_twi_enable_irq(void *base_addr);
extern void aw_twi_disable_irq(void *base_addr);
extern void aw_twi_disable_bus(void *base_addr);
extern void aw_twi_enable_bus(void *base_addr);
extern void aw_twi_set_start(void *base_addr);
extern unsigned int  aw_twi_get_start(void *base_addr);
extern void aw_twi_set_stop(void *base_addr);
extern unsigned int  aw_twi_get_stop(void *base_addr);
extern void aw_twi_disable_ack(void *base_addr);
extern void aw_twi_enable_ack(void *base_addr);
extern void aw_twi_clear_irq_flag(void *base_addr);
extern unsigned int  aw_twi_query_irq_flag(void *base_addr);
extern unsigned int  aw_twi_query_irq_status(void *base_addr);
extern void aw_twi_set_clock(unsigned int  clk_in,unsigned int  sclk_req, void *base_addr);
extern void aw_twi_soft_reset(void *base_addr);
extern void aw_twi_set_EFR(void *base_addr, unsigned int  efr);
/* AW1620 use only  */
extern void aw_twi_set_sda(void *base_addr,unsigned int  hi_lo);
extern unsigned int  aw_twi_get_sda(void *base_addr);
extern void aw_twi_set_scl(void *base_addr, unsigned int  hi_lo);
extern unsigned int  aw_twi_get_scl(void *base_addr);
extern void aw_twi_enable_LCR(void *base_addr, unsigned int  sda_scl);
extern void aw_twi_disable_LCR(void *base_addr, unsigned int  sda_scl);
