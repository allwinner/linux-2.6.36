...
//	int ret;
	...
	/* get usbc_init_state */
/*	ret = script_parser_fetch("usb_config", "usb_wifi_host", (int *)&usb_wifi_host, 64);
	if(ret != 0){
		ERR_8192C("ERR: script_parser_fetch usbc_init_state failed\n");
		ret = -ENOMEM;
		return ret;
	}
*/
	MSG_8192C("usb_wifi_host = %d\n", usb_wifi_host);
