...
*********************************************************************************************************
*/
#ifndef _SUN3I_SPI_PRIVATE_H_
#define _SUN3I_SPI_PRIVATE_H_
...
/*   internal use only  */
extern s32 aw_spi_set_cs(u32 chipselect, void *base_addr);
extern void  aw_spi_config(u32 master, u32 config,void *base_addr);
extern void  aw_spi_restore_state(u32 master, void *base_addr);
extern void  aw_spi_set_clk(u32 spi_clk, u32 ahb_clk, void *base_addr);
extern void  aw_spi_start_xfer(void *base_addr);
extern  u32 aw_spi_query_xfer(void *base_addr);
extern  void aw_spi_enable_bus(void *base_addr);
extern  void aw_spi_disable_bus(void *base_addr);
extern  void aw_spi_set_master(void *base_addr);
extern  void aw_spi_set_slave(void *base_addr);
extern  void aw_spi_set_tbw(u32 bits_per_word, void *base_addr);
extern  void aw_spi_disable_irq(u32 bitmap, void *base_addr);
extern  void aw_spi_enable_irq(u32 bitmap, void *base_addr);
extern  void aw_spi_disable_dma_irq(u32 bitmap, void *base_addr);
extern  void aw_spi_enable_dma_irq(u32 bitmap, void *base_addr);
extern  u32 aw_spi_qry_irq_pending(void *base_addr);
extern  void aw_spi_clr_irq_pending(u32 pending_bit, void *base_addr);
extern  u32 aw_spi_query_txfifo(void *base_addr);
extern u32 aw_spi_query_rxfifo(void *base_addr);
extern void aw_spi_reset_fifo(void *base_addr);
extern void aw_spi_set_bc_wtc(u32 tx_len, u32 rx_len, void *base_addr);
extern void aw_spi_ss_ctrl(void *base_addr, u32 on_off);
extern void aw_spi_ss_level(void *base_addr, u32 hi_lo);
extern void aw_spi_set_waitclk_cnt(u32 waitclk_cnt, void *base_addr);
extern void aw_spi_set_sample_delay(u32 on_off, void *base_addr);
extern s32 aw_spi_sel_dma_type(u32 dma_mode, void *base_addr);
