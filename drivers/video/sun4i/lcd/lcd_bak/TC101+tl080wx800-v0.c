...
static __bool IIC_Write_forT101(__u8 slave_addr, __u16 sub_addr, __u8 value)
{
...
static void  LCD_open_cmd(__u32 sel)
{
    IIC_Write_forT101(0xfc, 0xf830, 0xb2);
    IIC_Write_forT101(0xfc, 0xf833, 0xc2);
    IIC_Write_forT101(0xfc, 0xf831, 0xf0);
    IIC_Write_forT101(0xfc, 0xf840, 0x80);
    IIC_Write_forT101(0xfc, 0xf881, 0xec);
}
