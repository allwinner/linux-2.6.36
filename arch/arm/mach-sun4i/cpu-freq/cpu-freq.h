...
#undef CPUFREQ_ERR
#if (1)
    #define CPUFREQ_DBG(format,args...)   printk("[cpu_freq]"format,##args)
    #define CPUFREQ_ERR(format,args...)   printk("[cpu_freq]"format,##args)
#else
...
#define SUN4I_FREQTRANS_LATENCY (1000000)       /* config the transition latency, based on ns */
