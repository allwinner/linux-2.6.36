...
struct cpufreq_frequency_table sun4i_freq_tbl[] = {
    ...
    { .frequency = 408000,  .index = SUN4I_CLK_DIV(1, 1, 4, 2), },
    { .frequency = 432000,  .index = SUN4I_CLK_DIV(1, 1, 4, 2), },
    { .frequency = 480000,  .index = SUN4I_CLK_DIV(1, 1, 4, 2), },
    ...
    { .frequency = 864000,  .index = SUN4I_CLK_DIV(1, 2, 2, 2), },
    { .frequency = 912000,  .index = SUN4I_CLK_DIV(1, 2, 2, 2), },
    { .frequency = 960000,  .index = SUN4I_CLK_DIV(1, 2, 2, 2), },
