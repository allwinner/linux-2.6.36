...
#define SUN4I_CCMBASE_AUDIOHOSCPLL (0x04)
	#define SUN4I_CCMBASE_AUDIOHOSCPLL_EN			(1<<29)
	#define SUN4I_CCMBASE_AUDIOHOSCPLL_24576M	(1<<26)
	#define SUN4I_CCMBASE_AUDIOHOSCPLL_225792M (0<<26)
	
#define SUN4I_CCMBASE_APBGATE	(0x10)
	#define SUN4I_CCMBASE_APBGATE_SPDIFGATE	(1<<12)

#define SUN4I_CCMBASE_AUDIOCLK (0x38)
	#define SUN4I_CCMBASE_AUDIOCLK_SPDIFSPEGATE	(1<<2)
